...
const Dashboard = () => {
  return (
    <div>
      <Header />
      <div className="intro_Container flex flex-col md:flex-row w-full bg-gradient-to-r from-yellow-100 via-pink-100 to-rose-200 pt-0 pr-4 pb-4 pl-0 md:pt-0 md:pr-10 md:pb-10 md:pl-0 mt-12 justify-center">


        {/* Image First on Mobile, Second on Desktop */}
        <div className="intro_Image w-[80%] md:w-1/2 max-w-sm mx-auto md:mx-0 bg-zoom-animation order-1 md:order-2"></div>
